...
#ifndef __CGOGN_SHADER_TEXTUREBLURH__
#define __CGOGN_SHADER_TEXTUREBLURH__
...
class ShaderTextureBlurH : public ClippingShader
{
...
#endif /* __CGOGN_SHADER_TEXTUREBLURH__ */
