...
//	bool loadMapXml(const std::string& filename, bool compress = false) ;
	...
	virtual bool foreach_dart_of_face(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
	virtual bool foreach_dart_of_volume(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
	virtual bool foreach_dart_of_cc(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }

	virtual bool foreach_dart_of_vertex1(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
	virtual bool foreach_dart_of_edge1(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }

	virtual bool foreach_dart_of_vertex2(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
	virtual bool foreach_dart_of_edge2(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
	virtual bool foreach_dart_of_face2(Dart UNUSED(d), FunctorType& UNUSED(f), unsigned int UNUSED(thread) = 0) { std::cerr << "Not implemented" << std::endl; return false; }
